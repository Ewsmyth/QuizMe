...
(function(e) {
        ...
        if (b != c)
            if (0 > b || b >= k)
                ...
                if (null !== a.aaSortingFixed)
                    for (d = 0,
                    g = a.aaSortingFixed.length; d < g; d++)
                ...
                for (g = k; d < g; d++)
                    n = a.aoColumns[d],
                    "number" == typeof n.mData ? n.mData = q[n.mData] : e.isPlainObject(n.mData) && (p(n.mData, "_", q),
                    p(n.mData, "filter", q),
                    p(n.mData, "sort", q),
                    p(n.mData, "type", q));
                if (a.aoColumns[b].bVisible) {
                    ...
                    for (d = c < b ? c : c + 1; null === m && d < k; )
                        m = this.oApi._fnColumnIndexToVisible(a, d),
                        d++;
    ...
    e.extend(r.prototype, {
        ...
        _fnConstruct: function() {
            ...
            for (f = 0; f < b; f++)
                f > this.s.fixed - 1 && f < b - this.s.fixedRight && this._fnMouseListener(f, this.s.dt.aoColumns[f].nTh),
        ...
        _fnOrderColumns: function(a) {
            ...
            if (a.length != this.s.dt.aoColumns.length)
                ...
                this._fnSetColumnIndexes();
                b && (e.fn.dataTable.Api(this.s.dt).rows().invalidate(),
        ...
        _fnMouseDown: function(a, b) {
            ...
            b !== z && (this.s.mouse.startX = this._fnCursorPosition(a, "pageX"),
            ...
            this._fnRegions(),
            e(t).on("mousemove.ColReorder touchmove.ColReorder", function(h) {
        ...
        _fnMouseMove: function(a) {
            ...
            this.s.mouse.toIndex = l.to) : (this.dom.pointer.css("left", g().x),
    ...
    "function" == typeof e.fn.dataTable && "function" == typeof e.fn.dataTableExt.fnVersionCheck && e.fn.dataTableExt.fnVersionCheck("1.10.8") ? e.fn.dataTableExt.aoFeatures.push({
        fnInit: function(a) {
            ...
            new r(a,b.colReorder || b.oColReorder || {}));
            return null
        },
        cFeature: "R",
        sFeature: "ColReorder"
    ...
    e.fn.dataTable.Api.register("colReorder.move()", function(a, b, c, f) {
        this.context.length && (this.context[0]._colReorder.s.dt.oInstance.fnColReorder(a, b, c, f),
